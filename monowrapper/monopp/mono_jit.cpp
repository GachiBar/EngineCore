...
bool init_with_mono_assembly_path(const std::string& mono_assembly_path, const std::string& domain, bool enable_debugging)
{
	mono_set_assemblies_path(mono_assembly_path.c_str());
	return init(domain, enable_debugging);
}

bool init_with_mono_dirs(const std::string& domain, bool enable_debugging)
{
